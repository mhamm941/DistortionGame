class gameOver extends Phaser.Scene {
    ...
    create() {
        ...
        this.introDia_2 = this.add.text(game.config.width/2, game.config.height/2 + 50, "Now… here comes my final question. [N]", {fontFamily: 'Carrera',}).setOrigin(0);
    ...
    update() {
        ...
        if(this.counter == 0 && Phaser.Input.Keyboard.JustDown(keyN)){
            ...
            this.introDia2 = this.add.text(game.config.width/2, game.config.height/2, "I just have one last question for you,", {fontFamily: 'Carrera',}).setOrigin(0);
            this.introDia2_1 = this.add.text(game.config.width/2, game.config.height/2 + 50, " stick around!", {fontFamily: 'Carrera',}).setOrigin(0);
        ...
        if(this.counter == 5 && Phaser.Input.Keyboard.JustDown(keyN)){
            ...
            this.introDia7 = this.add.text(game.config.width/2, game.config.height/2, "STOP!", {fontFamily: 'Carrera',}).setOrigin(0);
