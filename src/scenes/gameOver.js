class gameOver extends Phaser.Scene {
    ...
    update() {
        ...
        if(this.counter == 0 && Phaser.Input.Keyboard.JustDown(keyN)){
            ...
            this.introDia2_1 = this.add.text(game.config.width/2, game.config.height/2 + 50, " stick around!").setOrigin(0);
            this.introDia2_2 = this.add.text(game.config.width/2, game.config.height/2 + 100, "...please... [N]").setOrigin(0);
            this.counter++;
        }
