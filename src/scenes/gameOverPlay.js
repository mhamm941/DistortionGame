class gameOverPlay extends Phaser.Scene {
    ...
    create() {
       ...
       this.physics.add.collider(spikeLayer, this.playerChar, this.check, null, this);
        ...
        this.introDia = this.add.text(this.playerChar.x, this.playerChar.y - 100, "Welcome, my…. Friend! [N]", {fontFamily: 'Carrera',}).setOrigin(0);
    ...
    update() {
        ...
        if( this.counter == 1 && Phaser.Input.Keyboard.JustDown(keyN)){
            ...
            this.introDia3 = this.add.text(this.playerChar.x - 100, this.playerChar.y - 150, "Who am I? No matter. Think of ", {fontFamily: 'Carrera',}).setOrigin(0);
            this.introDia3line = this.add.text(this.playerChar.x - 100, this.playerChar.y - 100, "me as your... friend, who’s here to help!", {fontFamily: 'Carrera',}).setOrigin(0);
            this.counter++;
        }
    ...
    if(this.counter == 6 && this.playerChar.x >= 2160 && this.playerChar.y <= 303){
        ...
        this.introDia8 = this.add.text(this.playerChar.x - 100, this.playerChar.y - 100, "Great job! Now, trust me, the exit door is just one big ", {fontFamily: 'Carrera',}).setOrigin(0);
